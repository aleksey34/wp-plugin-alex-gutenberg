...
//  import  { useBlockProps } from '@wordpress/block-editor';
  ...
  */
    ...
    export default function Edit({attributes:{quantity, title} , setAttributes}) {
     ...
     return (
        <>
            ...
            <div { ...useBlockProps() } style={{display:"flex", flexWrap:'wrap'}}>
				...
				{ posts?.map((item)=>(
                <article key={item.id} style={{flex:"0 0 33%"}} className={`large-entry blog-entry clr`}>
